...
class ResourcesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create resource" do
    assert_difference("Resource.count") do
      post resources_url, params: { resource: { descripcion: @resource.descripcion, nombre: @resource.nombre } }
    end
  ...
  test "should update resource" do
    patch resource_url(@resource), params: { resource: { descripcion: @resource.descripcion, nombre: @resource.nombre } }

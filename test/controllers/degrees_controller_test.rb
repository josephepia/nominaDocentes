...
class DegreesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create degree" do
    assert_difference("Degree.count") do
      post degrees_url, params: { degree: { degreetype_id: @degree.degreetype_id, descripcion: @degree.descripcion, nombre: @degree.nombre, user_id: @degree.user_id } }
    end
  ...
  test "should update degree" do
    patch degree_url(@degree), params: { degree: { degreetype_id: @degree.degreetype_id, descripcion: @degree.descripcion, nombre: @degree.nombre, user_id: @degree.user_id } }

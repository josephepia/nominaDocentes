...
class PermissionsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create permission" do
    assert_difference("Permission.count") do
      post permissions_url, params: { permission: { descripcion: @permission.descripcion, nombre: @permission.nombre } }
    end
  ...
  test "should update permission" do
    patch permission_url(@permission), params: { permission: { descripcion: @permission.descripcion, nombre: @permission.nombre } }

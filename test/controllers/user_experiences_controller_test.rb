...
class UserExperiencesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create user_experience" do
    assert_difference("UserExperience.count") do
      post user_experiences_url, params: { user_experience: { anos: @user_experience.anos, experience_id: @user_experience.experience_id, user_id: @user_experience.user_id } }
    end
  ...
  test "should update user_experience" do
    patch user_experience_url(@user_experience), params: { user_experience: { anos: @user_experience.anos, experience_id: @user_experience.experience_id, user_id: @user_experience.user_id } }

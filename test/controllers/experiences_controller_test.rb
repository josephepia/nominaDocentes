...
class ExperiencesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create experience" do
    assert_difference("Experience.count") do
      post experiences_url, params: { experience: { descripcion: @experience.descripcion, puntaje: @experience.puntaje } }
    end
  ...
  test "should update experience" do
    patch experience_url(@experience), params: { experience: { descripcion: @experience.descripcion, puntaje: @experience.puntaje } }

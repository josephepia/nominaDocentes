...
class ActionsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create action" do
    assert_difference("Action.count") do
      post actions_url, params: { action: { descripcion: @action.descripcion, nombre: @action.nombre } }
    end
  ...
  test "should update action" do
    patch action_url(@action), params: { action: { descripcion: @action.descripcion, nombre: @action.nombre } }

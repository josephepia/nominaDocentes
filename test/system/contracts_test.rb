...
class ContractsTest < ApplicationSystemTestCase
  ...
  test "should create contract" do
    ...
    fill_in "Descripcion", with: @contract.descripcion
    fill_in "Horasrestantes", with: @contract.horasRestantes
    fill_in "Horassemanales", with: @contract.horasSemanales
    fill_in "Horastrabajadas", with: @contract.horasTrabajadas

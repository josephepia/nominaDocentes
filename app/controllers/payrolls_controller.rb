class PayrollsController < ApplicationController
  ...
  private
    ...
    def payroll_params
      params.require(:payroll).permit(:sueldoBase, :bonificacionTotal, :valorHorasTrabajadas, :horasTrabajadas, :sueldoTotal, :horasRestante, :horasPorTrabajar, :valorHorasRestantes, :user_id, :degrretype_id, :researchtype_id, :fee_id, :contract_id)
    end
end

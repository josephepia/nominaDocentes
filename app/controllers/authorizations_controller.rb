class AuthorizationsController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @authorization.save
        format.html { redirect_to authorization_url(@authorization), notice: "Authorization was successfully created." }
  ...
  def update
    respond_to do |format|
      if @authorization.update(authorization_params)
        format.html { redirect_to authorization_url(@authorization), notice: "Authorization was successfully updated." }
  ...
  private
    ...
    def authorization_params
      params.require(:authorization).permit(:user_id, :resource_id, :action_id)
    end
end

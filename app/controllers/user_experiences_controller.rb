class UserExperiencesController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @user_experience.save
        format.html { redirect_to user_experience_url(@user_experience), notice: "User experience was successfully created." }
  ...
  def update
    respond_to do |format|
      if @user_experience.update(user_experience_params)
        format.html { redirect_to user_experience_url(@user_experience), notice: "User experience was successfully updated." }
  ...
  private
    ...
    def user_experience_params
      params.require(:user_experience).permit(:anos, :experience_id, :user_id)
    end
end
